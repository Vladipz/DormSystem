...
// One-minute profile variant of the wide detail endpoint test.
export const options = {
  ...
  thresholds: {
    ...
    'http_req_duration{scenario:warmup,endpoint:get-event-detail}': ['p(95)<700'],
    'http_req_duration{scenario:normal_load,endpoint:get-event-detail}': ['p(95)<1000'],
    'http_req_duration{scenario:peak_load,endpoint:get-event-detail}': ['p(95)<1500'],
    'http_req_duration{scenario:stress_test,endpoint:get-event-detail}': ['p(95)<2200'],
